...
const sentences = [
  "ひらがなを短時間で手軽に習得したい人におすすめのアプリです。ひらがなバブルを使えば、ゲームを楽しみながらひらがなの形を見分ける力をすばやく習得することができます。基本的なひらがなに加えて「ば」や「ぱ」などの濁音や半濁音といった、学習者がつまづきがちな文字もゲームを通して覚えることができます。一度ダウンロードすればインターネットは必要ありません。広告表示が一切ないため、安心してお子様にもご利用いただけます。",
  "日本語学習者にひらがなの美しさを体感いただけるよう、シンプルで洗練された和なデザインに仕上げました。ひらがなの音声ガイダンスにそって、ヒントを頼りに正しい書き順と美しいバランスでひらがなを書く力を習得できます。一度ダウンロードすればインターネットは必要ありません。広告表示が一切ないため、安心してお子様にもご利用いただけます。",
  "ひらがなクラッシュであなたの”ひらがな脳”を鍛えましょう。人気のクラッシュゲームをひらがなで楽しみながら、ひらがなの形を覚えることができるアプリです。一度ダウンロードすればインターネットは必要ありません。広告表示が一切ないため、安心してお子様にもご利用いただけます。",
    ...
    <div>
      ...
      <div className="mobile-design-container">
        ...
        <div className="box-B">
          ...
          ご購入されたアプリを長くご利用いただけるよう、常にiOSの最新バージョンへのアップデートとメンテナンスを継続することを約束いたします。今後のサービス向上のため、皆さまからのご意見・ご感想をお待ちしております。
        </div>
