...
const sentences = [
  ...
  "日本語学習者にひらがなの美しさを体感いただけるよう、シンプルで洗練された和のデザインに仕上げました。ひらがなの音声ガイダンスにそって、ヒントを頼りに正しい書き順と美しいバランスでひらがなを書く力を習得できます。一度ダウンロードすればインターネットは必要ありません。広告表示が一切ないため、安心してお子様にもご利用いただけます。",
